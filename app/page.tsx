  ...
  return (
    <main className="lg:text-lg">
      <div className="flex flex-col pt-4">
        ...
        <p className="mb-3 lg:mb-5">I use this project to create my <strong>own notes</strong> about things I have learnt in Next.js from my experience in other projects, documentation and courses.</p>
