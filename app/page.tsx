    ...
    <main className="lg:text-lg">
      <div className="flex flex-col pt-4 lg:pt-12">
        <AnimatedContainer>
          ...
          <p className="mb-4 lg:mb-5">This project provides notes and practical examples designed to help beginners understand some of the main concepts of Next.js.</p>
